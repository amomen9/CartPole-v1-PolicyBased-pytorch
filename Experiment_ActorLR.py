...
def experiment():
    ...
    global_config = {
        ...
        "plot_smoothing_window": [201, 251, 351],  # Use multiple values to plot multiple curves. Default: [1, 51, 101, 201, 251, 301]. Set to [1] to skip smoothing.
    ...
    PPO_config = {
        "gamma": [0.99],                  # list of discount factors to sweep
        "actor_lr": [1e-4, 3e-4, 0.001],               # actor learning rate(s) to sweep
