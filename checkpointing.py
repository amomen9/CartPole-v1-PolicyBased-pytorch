...
def resolve_matching_checkpoint_path(*, checkpoint_path: str, metadata: dict | None = None) -> str | None:
    """
    ...
    target_metadata = _normalize_metadata(metadata)
...
def load_state_dict_if_present(*, model: torch.nn.Module, checkpoint_path: str, metadata: dict | None = None) -> bool:
    resolved_path = resolve_matching_checkpoint_path(checkpoint_path=checkpoint_path, metadata=metadata)
